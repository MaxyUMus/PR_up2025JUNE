...
namespace maxim_1
{
    ...
    {
        internal static string ConnectionString = "Host=localhost;Port=5433;Database=motorist;Username=postgres;Password=11111111";
        internal static Color PrimaryBackgroundColor = ColorTranslator.FromHtml("#FFFFFF");
        internal static Color SecondaryBackgroundColor = ColorTranslator.FromHtml("#A4A4A3");
        internal static Color AccentColor = ColorTranslator.FromHtml("#790202");
