...
namespace maxim_1
{
    ...
    {
        internal static string ConnectionString = "Host=localhost;Port=5433;Database=gold_fish;Username=postgres;Password=11111111";
        internal static Color PrimaryBackgroundColor = ColorTranslator.FromHtml("#FFFFFF");
        internal static Color SecondaryBackgroundColor = ColorTranslator.FromHtml("#F7FCBD");
        internal static Color AccentColor = ColorTranslator.FromHtml("#022E4D");
