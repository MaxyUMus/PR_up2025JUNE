...
namespace maxim_1
{
    ...
    {
        internal static string ConnectionString = "Host=localhost;Port=5433;Database=employment_center;Username=postgres;Password=11111111";
        internal static Color PrimaryBackgroundColor = ColorTranslator.FromHtml("#FFFFFF");
        internal static Color SecondaryBackgroundColor = ColorTranslator.FromHtml("#FAB384");
        internal static Color AccentColor = ColorTranslator.FromHtml("#009335");
        internal static NpgsqlConnection Connection = new NpgsqlConnection(ConnectionString);
        internal static ColorScheme ColorScheme = new ColorScheme(PrimaryBackgroundColor, SecondaryBackgroundColor, SecondaryBackgroundColor, AccentColor, Methods.GetContrastTextShade(SecondaryBackgroundColor));
    }
