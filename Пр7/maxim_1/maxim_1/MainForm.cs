...
namespace maxim_1
{
    public partial class MainForm : MaterialForm
    {
        ...
        private void Init()
        {
            ...
            btn_save.BackColor = btn_delete.BackColor = Constants.SecondaryBackgroundColor;
            btn_save.IconColor = btn_delete.IconColor = Methods.GetContrastTextColor(Constants.SecondaryBackgroundColor);
        }
