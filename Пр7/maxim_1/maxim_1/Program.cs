...
namespace maxim_1
{
    ...
    {
        internal static string ConnectionString = "Host=localhost;Port=5433;Database=tech_support;Username=postgres;Password=11111111";
        internal static Color PrimaryBackgroundColor = ColorTranslator.FromHtml("#FFFFFF");
        internal static Color SecondaryBackgroundColor = ColorTranslator.FromHtml("#FDD7A7");
        internal static Color AccentColor = ColorTranslator.FromHtml("#030395");
