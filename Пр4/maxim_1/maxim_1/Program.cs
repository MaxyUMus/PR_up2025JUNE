...
namespace maxim_1
{
    ...
    {
        internal static string ConnectionString = "Host=localhost;Port=5433;Database=farm_store;Username=postgres;Password=11111111";
        internal static Color PrimaryBackgroundColor = ColorTranslator.FromHtml("#FFFFFF");
        internal static Color SecondaryBackgroundColor = ColorTranslator.FromHtml("#FFFF99");
        internal static Color AccentColor = ColorTranslator.FromHtml("#39793D");
