...
namespace maxim_1
{
    public partial class MainForm : MaterialForm
    {
        ...
        private void Init()
        {
            ...
            Icon = new System.Drawing.Icon("images/app_icon.ico");
            btn_save.Icon = IconChar.FloppyDisk.ToBitmap(Methods.GetContrastTextColor(Constants.SecondaryBackgroundColor), 36);
            btn_delete.Icon = IconChar.Trash.ToBitmap(Methods.GetContrastTextColor(Constants.SecondaryBackgroundColor), 36);
        }
        ...
        private void tables_box_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (var fk in fkData)
            {
                if (table_view.Columns.Contains(fk.Key))
                {
                    ...
                    else if (fk.Value.Columns.Contains(col_name + "_number"))
                    {
                        col_name += "_number";
                    }
